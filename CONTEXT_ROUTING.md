...
- core/values.md
- Relevant framework
- Related patterns (e.g. `organizational-memory.md`, `exception-as-memory-entry.md`, `connected-organizational-memory.md`, `memory-at-decision.md`, `standard-as-learned-memory.md` for Memory Arc)
