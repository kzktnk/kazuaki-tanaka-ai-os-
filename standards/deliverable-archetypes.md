...
**Origin:** レガシー成果物アーキタイプの**最小構成**テンプレ。クライアント名・固有情報なし。Archetype J はコーチング録音（2026-08-24／2026-08-28）の一般化。中間報告の確認セットは 2026-09。
...
**避ける:** 30枚の進捗羅列、決定前の網羅報告。抽出過程の作業紙を中間報告の主線にしない（`knowledge/patterns/interim-as-confirmation-set.md`）。
...
**原則:** 500だけ独立ストーリーを作らない。本体成果物の**要約**であること。中間時点なら、最終の圧縮ではなく **確認セット**（共有前提＋今期の Critical/High）である（`knowledge/patterns/interim-as-confirmation-set.md`）。
