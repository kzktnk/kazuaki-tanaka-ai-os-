...
### Y. Consultant skill model v0.6 and Role / Pilot (2026-09)

```text
Local S&T Cons Capa pack — md only; docx not archived
        ↓ replace v0.1 draft; add Role + Learning Map + Pilot worksheet
frameworks/consultant-capability-skill-model.md (v0.6, 4 Capability / 24 Skill)
frameworks/consultant-role-responsibility-model.md (v0.3)
...
### AC. Capability Model path correction (2026-09)

```text
Local pack FInal_260902_2347 — md only; docx not archived
        ↓ record: ③ / 横串 already in repo; missing-file look-up used operations-transition.md
frameworks/consultant-capability-skill-model.md (v0.6.4)
        ↓ keep repo Directory (pack snapshot was older)
frameworks/skill-playbook-directory.md
        ↓ record
...
### AD. CCAR Agentic / MCP / Subagent (2026-09)

```text
Local CCAR study cheat sheets — not archived (no exam items / scores)
        ↓ generalize
...
knowledge/patterns/subagent-when-isolation-justifies-cost.md
        ↓ connect
adapters/claude/CLAUDE.md (v1.1)
...
knowledge/migrations/ccar-agentic-mcp-subagents-2026-09.md
        ↓ task routing
CONTEXT_ROUTING.md  →  Agent / MCP / Subagent Design, Responsible AI, AI Governance
```
...
### AG. CCAR Prompt Evaluation and Claude API (2026-09)

```text
Local CCAR cheat sheets 2026-09-08 — not archived
        ↓ generalize (no exam items / scores)
...
knowledge/migrations/ccar-prompt-eval-and-api-2026-09.md
        ↓ task routing
CONTEXT_ROUTING.md  →  AI PoC, Responsible AI, Agent / MCP
```
...
### AI. SI Project Literacy (2026-09)

```text
Local draft si-project-literacy_5.md — not archived (no client names / Pilot scores)
        ↓ register Cap II Prerequisite candidate (draft until Pilot)
frameworks/si-project-literacy.md (v0.6)
        ↓ connect
playbooks/cross-project-program-management.md (+ selfstudy)
frameworks/skill-playbook-directory.md
frameworks/consultant-capability-skill-model.md (v0.6.5)
        ↓ record
knowledge/migrations/si-project-literacy-2026-09.md
        ↓ task routing
CONTEXT_ROUTING.md  →  Transformation PMO, Consultant Enablement
```
...
### AN. Stay then re-propose on handover (2026-09)

```text
Local working session 2026-09-16 — not archived (no client IDs / minutes / decks)
        ↓ generalize (interim confirmation and site-led activation already ingested)
...
core/author-voice.md
        ↓ record
knowledge/migrations/stay-then-repropose-on-handover-2026-09.md
        ↓ task routing
CONTEXT_ROUTING.md  →  Transformation PMO, Change Management
```
